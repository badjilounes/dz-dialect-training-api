...
describe('(TrainingController) professor/create-presentation', () => {
  ...
  it('should throw conflict error if a training presentation already exist', async () => {
    ...
    await request(app.getHttpServer()).post('/professor/training/create-presentation');
    await request(app.getHttpServer()).post('/professor/training/create-presentation').expect(HttpStatus.CONFLICT);
  });
  ...
  it('should return created training presentation', async () => {
    ...
    const { body } = await request(app.getHttpServer())
      .post('/professor/training/create-presentation')
