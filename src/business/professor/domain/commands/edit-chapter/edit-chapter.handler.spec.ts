...
import { EditChapterHandler } from './edit-chapter.handler';

import { EventPublisher } from '@cqrs/event';
import { UuidGenerator } from '@ddd/domain/uuid/uuid-generator.interface';

describe('Create chapter', () => {
  let handler: EditChapterHandler;
  ...
  beforeEach(() => {
    ...
    handler = new EditChapterHandler(trainingChapterCommandRepository, uuidGenerator, eventPublisher);
