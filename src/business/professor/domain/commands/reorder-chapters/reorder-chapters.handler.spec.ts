...
import { ReorderChaptersHandler } from './reorder-chapters.handler';

import { EventPublisher } from '@cqrs/event';
import { UuidGenerator } from '@ddd/domain/uuid/uuid-generator.interface';

describe('Create chapter', () => {
  let handler: ReorderChaptersHandler;
  ...
  beforeEach(() => {
    ...
    handler = new ReorderChaptersHandler(trainingChapterCommandRepository, uuidGenerator, eventPublisher);
